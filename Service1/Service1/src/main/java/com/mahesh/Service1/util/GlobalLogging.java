package com.mahesh.Service1.util;
...
public class GlobalLogging {
    ...
    @Pointcut(value = "execution(* com.mahesh.Service1..*.*(..))")
    ...
    private void pushStack(JoinPoint joinPoint) {
        String methodName = StringUtils.replace(joinPoint.getSignature().toString(), "com.mahesh.Service1.", "");

package com.mahesh.Service3.util;
...
public class GlobalLogging {
    ...
    @Pointcut(value = "execution(* com.mahesh.Service3..*.*(..))")
    ...
    private void pushStack(JoinPoint joinPoint) {
        String methodName = StringUtils.replace(joinPoint.getSignature().toString(), "com.mahesh.Service3.", "");
